...
/obj/machinery/computer/nuke_disk_generator/proc/update_minimap_icon()
	...
	SSminimaps.add_marker(src, MINIMAP_FLAG_ALL, image('modular_RUtgmc/icons/UI_icons/map_blips_large.dmi', null, "[disk_color]_disk[current_timer ? "_on" : "_off"]")) //RUTGMC EDIT
