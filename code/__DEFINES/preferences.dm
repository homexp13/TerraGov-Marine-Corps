...
#define BACK_GREEN_SATCHEL 4 // RUTGMC ADDITION START
#define BACK_MOLLE_BACKPACK 5
#define BACK_MOLLE_SATCHEL 6
#define BACK_SCAV_BACKPACK 7 // RUTGMC ADDITION END
